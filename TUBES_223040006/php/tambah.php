        ...
        <form action="" method="POST">
            ...
            <div class="mb-3">
                <label for="harga" class="col-sm-2 col-form-label">Harga</label>
                    <input type="text" class="form-control" id="harga" name="harga" placeholder="Text Input" required>
            </div>
            <div class="mb-3">
                <label for="alamat" class="form-label">Alamat</label>
                    <input class="form-control" type="text" placeholder="Text Input" id="alamat" name="alamat">
            </div>
            <div class="mb-3">
